...
4. Select "Administrative Templates" => "OLI" - either in "Computer Configuration" or "User Configuration" it shouldn't matter.
...
8. Now if you open your OLI desktop application you should be able to see the server in the server dropdown
